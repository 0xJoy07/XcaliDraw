...
// SVG components for Google/GitHub
const GoogleIcon = () => (
      ...
      <div className="w-full max-w-sm">
        ...
        <RoughCard>
          <div className="mb-6 text-center">
            <h1 className="text-3xl font-virgil text-ink">Sign up</h1>
            <p className="mt-1 text-sm font-virgil text-ink/70">Create your Xcalidraw account.</p>
          </div>

          <form onSubmit={handleSubmit} className="space-y-4">
            <label className="block">
              <span className="text-sm font-sans font-medium text-ink">Name</span>
              <RoughInput
                value={name}
